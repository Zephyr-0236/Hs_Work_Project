    ...
    )
{
    ...
    pDataParams = NULL;	pDataParams = pDataParams; wPortBufSize = wPortBufSize; pPortNames = pPortNames; 
    wPortBufSize = 0;
    pPortNames = NULL;
    *pNumOfPorts = 0;
                            ...
                            )
{
    ...
    pDataParams = NULL;	pDataParams = pDataParams; pPortName = pPortName; 
    pPortName = NULL;
                                  ...
                                  )
{
    ...
    pDataParams = NULL; pDataParams = pDataParams;
                                  ...
                                  )
{
	...
	phStatus_t status = PH_ERR_SUCCESS;	wOption = wOption;
                                   ...
                                   )
{
    ...
    pDataParams = NULL;	pDataParams = pDataParams; wConfig = wConfig; wValue = wValue;
    wConfig = 0;
    wValue = 0;
                                   ...
                                   )
{
    ...
    pDataParams = NULL;	pDataParams = pDataParams; wConfig = wConfig; pValue = pValue;
    wConfig = 0;
    pValue = NULL;
